...
; NONEON-NOSVE-NEXT:    ldrh w8, [sp, #106]
; NONEON-NOSVE-NEXT:    ldrh w9, [sp, #108]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #110]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #104]
...
; NONEON-NOSVE-NEXT:    strh wzr, [sp, #102]
; NONEON-NOSVE-NEXT:    stur wzr, [sp, #98]
...
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #76]
...
; NONEON-NOSVE-NEXT:  // %bb.5: // %else6
; NONEON-NOSVE-NEXT:    tbnz w8, #3, .LBB0_8
; NONEON-NOSVE-NEXT:  .LBB0_6: // %else10
; NONEON-NOSVE-NEXT:    add sp, sp, #112
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB0_7: // %cond.load5
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:    str w9, [sp, #48]
...
; NONEON-NOSVE-NEXT:  .LBB0_8: // %cond.load9
...
; NONEON-NOSVE-NEXT:    add sp, sp, #112
; NONEON-NOSVE-NEXT:    ret
  %load = call <4 x i8> @llvm.masked.expandload.v4i8(ptr %src, <4 x i1> %mask, <4 x i8> zeroinitializer)
  ret <4 x i8> %load
}
...
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    ldrb w9, [x0], #1
; CHECK-NEXT:    strh wzr, [sp, #6]
; CHECK-NEXT:    strh wzr, [sp, #4]
; CHECK-NEXT:    strh wzr, [sp, #2]
; CHECK-NEXT:    strb wzr, [sp, #1]
...
; CHECK-NEXT:  .LBB1_13: // %cond.load17
...
; CHECK-NEXT:    tbz w8, #7, .LBB1_16
; CHECK-NEXT:  .LBB1_15: // %cond.load25
...
; NONEON-NOSVE-NEXT:  .LBB1_7: // %else14
; NONEON-NOSVE-NEXT:    tbnz w8, #5, .LBB1_14
; NONEON-NOSVE-NEXT:  .LBB1_8: // %else18
; NONEON-NOSVE-NEXT:    tbnz w8, #6, .LBB1_15
; NONEON-NOSVE-NEXT:  .LBB1_9: // %else22
; NONEON-NOSVE-NEXT:    tbnz w8, #7, .LBB1_16
; NONEON-NOSVE-NEXT:  .LBB1_10: // %else26
; NONEON-NOSVE-NEXT:    add sp, sp, #256
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB1_11: // %cond.load5
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB1_12: // %cond.load9
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB1_13: // %cond.load13
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB1_14: // %cond.load17
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB1_15: // %cond.load21
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB1_16: // %cond.load25
; NONEON-NOSVE-NEXT:    ldrb w8, [x0]
; NONEON-NOSVE-NEXT:    str d0, [sp, #8]
...
; NONEON-NOSVE-NEXT:    add sp, sp, #256
; NONEON-NOSVE-NEXT:    ret
  %load = call <8 x i8> @llvm.masked.expandload.v8i8(ptr %src, <8 x i1> %mask, <8 x i8> zeroinitializer)
  ret <8 x i8> %load
}
...
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    ldrb w9, [x0], #1
; CHECK-NEXT:    strh wzr, [sp, #14]
; CHECK-NEXT:    strh wzr, [sp, #12]
; CHECK-NEXT:    strh wzr, [sp, #10]
; CHECK-NEXT:    strh wzr, [sp, #8]
; CHECK-NEXT:    strh wzr, [sp, #6]
; CHECK-NEXT:    strh wzr, [sp, #4]
; CHECK-NEXT:    strh wzr, [sp, #2]
; CHECK-NEXT:    strb wzr, [sp, #1]
...
; CHECK-NEXT:  .LBB2_11: // %cond.load29
...
; CHECK-NEXT:  .LBB2_13: // %cond.load37
...
; CHECK-NEXT:  .LBB2_15: // %cond.load45
...
; CHECK-NEXT:  .LBB2_17: // %cond.load53
...
; CHECK-NEXT:  .LBB2_21: // %cond.load17
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z1.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z2.b, w9
...
; CHECK-NEXT:  .LBB2_23: // %cond.load25
...
; CHECK-NEXT:  .LBB2_25: // %cond.load33
...
; CHECK-NEXT:  .LBB2_27: // %cond.load41
...
; CHECK-NEXT:  .LBB2_29: // %cond.load49
...
; CHECK-NEXT:    tbz w8, #15, .LBB2_32
; CHECK-NEXT:  .LBB2_31: // %cond.load57
...
; NONEON-NOSVE-NEXT:  .LBB2_21: // %cond.load9
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_23: // %cond.load17
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_24: // %cond.load21
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_25: // %cond.load25
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_26: // %cond.load29
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_27: // %cond.load33
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_28: // %cond.load37
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_29: // %cond.load41
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_30: // %cond.load45
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_31: // %cond.load49
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB2_32: // %cond.load53
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:    b .LBB2_19
  %load = call <16 x i8> @llvm.masked.expandload.v16i8(ptr %src, <16 x i1> %mask, <16 x i8> zeroinitializer)
  ret <16 x i8> %load
}
...
; CHECK-NEXT:    ldr w8, [sp, #240]
; CHECK-NEXT:    ldr w9, [sp, #232]
; CHECK-NEXT:    ptrue p0.b, vl16
; CHECK-NEXT:    strb w7, [sp, #22]
...
; CHECK-NEXT:    strb w6, [sp, #21]
; CHECK-NEXT:    ldr q2, [x8, :lo12:.LCPI3_0]
; CHECK-NEXT:    strb w5, [sp, #20]
; CHECK-NEXT:    strb w4, [sp, #19]
; CHECK-NEXT:    strb w3, [sp, #18]
; CHECK-NEXT:    strb w2, [sp, #17]
; CHECK-NEXT:    strb w1, [sp, #16]
...
; CHECK-NEXT:    strb w9, [sp]
; CHECK-NEXT:    ldr q0, [sp]
; CHECK-NEXT:    tbnz w8, #1, .LBB3_33
; CHECK-NEXT:  .LBB3_2: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB3_34
; CHECK-NEXT:  .LBB3_3: // %cond.load5
; CHECK-NEXT:    mov w9, #2 // =0x2
...
; CHECK-NEXT:  .LBB3_11: // %cond.load37
; CHECK-NEXT:    mov w9, #10 // =0xa
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_13: // %cond.load45
; CHECK-NEXT:    mov w9, #12 // =0xc
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_15: // %cond.load53
; CHECK-NEXT:    mov w9, #14 // =0xe
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_17: // %cond.load61
; CHECK-NEXT:    ldrb w9, [x0], #1
; CHECK-NEXT:    ptrue p0.b, vl1
; CHECK-NEXT:    mov z1.b, p0/m, w9
; CHECK-NEXT:    tbnz w8, #17, .LBB3_49
; CHECK-NEXT:  .LBB3_18: // %else66
; CHECK-NEXT:    tbz w8, #18, .LBB3_50
; CHECK-NEXT:  .LBB3_19: // %cond.load69
; CHECK-NEXT:    mov w9, #2 // =0x2
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_21: // %cond.load77
; CHECK-NEXT:    mov w9, #4 // =0x4
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_23: // %cond.load85
; CHECK-NEXT:    mov w9, #6 // =0x6
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_25: // %cond.load93
; CHECK-NEXT:    mov w9, #8 // =0x8
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_27: // %cond.load101
; CHECK-NEXT:    mov w9, #10 // =0xa
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_29: // %cond.load109
; CHECK-NEXT:    mov w9, #12 // =0xc
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_31: // %cond.load117
; CHECK-NEXT:    mov w9, #14 // =0xe
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_37: // %cond.load17
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_39: // %cond.load25
; CHECK-NEXT:    mov w9, #7 // =0x7
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_41: // %cond.load33
; CHECK-NEXT:    mov w9, #9 // =0x9
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_43: // %cond.load41
; CHECK-NEXT:    mov w9, #11 // =0xb
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_45: // %cond.load49
; CHECK-NEXT:    mov w9, #13 // =0xd
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_47: // %cond.load57
...
; CHECK-NEXT:  .LBB3_49: // %cond.load65
; CHECK-NEXT:    mov w9, #1 // =0x1
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_51: // %cond.load73
; CHECK-NEXT:    mov w9, #3 // =0x3
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_53: // %cond.load81
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_55: // %cond.load89
; CHECK-NEXT:    mov w9, #7 // =0x7
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_57: // %cond.load97
; CHECK-NEXT:    mov w9, #9 // =0x9
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_59: // %cond.load105
; CHECK-NEXT:    mov w9, #11 // =0xb
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:  .LBB3_61: // %cond.load113
; CHECK-NEXT:    mov w9, #13 // =0xd
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
; CHECK-NEXT:    mov z3.b, w9
...
; CHECK-NEXT:    tbz w8, #31, .LBB3_64
; CHECK-NEXT:  .LBB3_63: // %cond.load121
; CHECK-NEXT:    mov w8, #15 // =0xf
; CHECK-NEXT:    index z2.b, #0, #1
; CHECK-NEXT:    ptrue p0.b
...
; NONEON-NOSVE-NEXT:  .LBB3_35: // %else122
; NONEON-NOSVE-NEXT:    add sp, sp, #2000
; NONEON-NOSVE-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB3_36: // %cond.load5
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_37: // %cond.load9
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_39: // %cond.load17
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_40: // %cond.load21
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_41: // %cond.load25
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_42: // %cond.load29
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_43: // %cond.load33
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_44: // %cond.load37
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_45: // %cond.load41
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_46: // %cond.load45
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_47: // %cond.load49
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_48: // %cond.load53
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_49: // %cond.load57
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_50: // %cond.load61
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_51: // %cond.load65
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_52: // %cond.load69
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_53: // %cond.load73
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_54: // %cond.load77
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_55: // %cond.load81
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_56: // %cond.load85
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_57: // %cond.load89
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_58: // %cond.load93
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_59: // %cond.load97
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_60: // %cond.load101
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_61: // %cond.load105
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_62: // %cond.load109
; NONEON-NOSVE-NEXT:    ldrb w10, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_63: // %cond.load113
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:  .LBB3_64: // %cond.load117
; NONEON-NOSVE-NEXT:    ldrb w9, [x0], #1
...
; NONEON-NOSVE-NEXT:    b .LBB3_35
  %load = call <32 x i8> @llvm.masked.expandload.v32i8(ptr %src, <32 x i1> %mask, <32 x i8> zeroinitializer)
  ret <32 x i8> %load
}
...
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    fmov h0, wzr
; CHECK-NEXT:    ldr h1, [x0], #2
; CHECK-NEXT:    zip1 z0.h, z1.h, z0.h
; CHECK-NEXT:    tbnz w8, #1, .LBB4_3
; CHECK-NEXT:    b .LBB4_4
; CHECK-NEXT:  .LBB4_2:
; CHECK-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB4_4
; CHECK-NEXT:  .LBB4_3: // %cond.load1
...
; NONEON-NOSVE-NEXT:    str h1, [sp, #16]
...
; NONEON-NOSVE-NEXT:    str h1, [sp, #10]
; NONEON-NOSVE-NEXT:    str h0, [sp, #8]
; NONEON-NOSVE-NEXT:    ldr d0, [sp, #8]
; NONEON-NOSVE-NEXT:  .LBB4_4: // %else2
; NONEON-NOSVE-NEXT:    add sp, sp, #32
; NONEON-NOSVE-NEXT:    ret
  %load = call <2 x half> @llvm.masked.expandload.v2f16(ptr %src, <2 x i1> %mask, <2 x half> zeroinitializer)
  ret <2 x half> %load
}
...
; CHECK-NEXT:    fmov h0, wzr
; CHECK-NEXT:    ldr h1, [x0], #2
; CHECK-NEXT:    zip1 z1.h, z1.h, z0.h
; CHECK-NEXT:    zip1 z0.h, z0.h, z0.h
...
; NONEON-NOSVE-NEXT:    str d0, [sp, #72]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #76]
; NONEON-NOSVE-NEXT:    str h1, [sp, #88]
; NONEON-NOSVE-NEXT:    ldr d0, [sp, #88]
; NONEON-NOSVE-NEXT:    str w9, [sp, #84]
; NONEON-NOSVE-NEXT:    str d0, [sp, #64]
...
; NONEON-NOSVE-NEXT:  .LBB5_6: // %else10
; NONEON-NOSVE-NEXT:    add sp, sp, #112
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB5_7: // %cond.load5
; NONEON-NOSVE-NEXT:    ldr h1, [x0], #2
; NONEON-NOSVE-NEXT:    str d0, [sp, #40]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #40]
; NONEON-NOSVE-NEXT:    str h1, [sp, #56]
; NONEON-NOSVE-NEXT:    ldr d0, [sp, #56]
; NONEON-NOSVE-NEXT:    str w9, [sp, #48]
; NONEON-NOSVE-NEXT:    str d0, [sp, #32]
...
; NONEON-NOSVE-NEXT:  .LBB5_8: // %cond.load9
; NONEON-NOSVE-NEXT:    ldr h1, [x0]
; NONEON-NOSVE-NEXT:    str d0, [sp]
; NONEON-NOSVE-NEXT:    ldr w8, [sp]
...
; NONEON-NOSVE-NEXT:    add sp, sp, #112
; NONEON-NOSVE-NEXT:    ret
  %load = call <4 x half> @llvm.masked.expandload.v4f16(ptr %src, <4 x i1> %mask, <4 x half> zeroinitializer)
  ret <4 x half> %load
}
...
; CHECK-NEXT:  .LBB6_13: // %cond.load17
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z1.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z2.h, w9
...
; CHECK-NEXT:    tbz w8, #7, .LBB6_16
; CHECK-NEXT:  .LBB6_15: // %cond.load25
; CHECK-NEXT:    mov w8, #7 // =0x7
; CHECK-NEXT:    index z1.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z2.h, w8
...
; NONEON-NOSVE-NEXT:  .LBB6_7: // %else14
; NONEON-NOSVE-NEXT:    tbnz w8, #5, .LBB6_15
; NONEON-NOSVE-NEXT:  .LBB6_8: // %else18
; NONEON-NOSVE-NEXT:    tbnz w8, #6, .LBB6_16
; NONEON-NOSVE-NEXT:  .LBB6_9: // %else22
; NONEON-NOSVE-NEXT:    tbz w8, #7, .LBB6_11
; NONEON-NOSVE-NEXT:  .LBB6_10: // %cond.load25
; NONEON-NOSVE-NEXT:    ldr h1, [x0]
; NONEON-NOSVE-NEXT:    str q0, [sp]
; NONEON-NOSVE-NEXT:    ldr w8, [sp, #8]
...
; NONEON-NOSVE-NEXT:  .LBB6_13: // %cond.load9
; NONEON-NOSVE-NEXT:    ldr h1, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #272]
...
; NONEON-NOSVE-NEXT:  .LBB6_15: // %cond.load17
; NONEON-NOSVE-NEXT:    ldr h1, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #144]
...
; NONEON-NOSVE-NEXT:  .LBB6_16: // %cond.load21
; NONEON-NOSVE-NEXT:    ldr h1, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #80]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #88]
...
; NONEON-NOSVE-NEXT:    b .LBB6_11
  %load = call <8 x half> @llvm.masked.expandload.v8f16(ptr %src, <8 x i1> %mask, <8 x half> zeroinitializer)
  ret <8 x half> %load
}
...
; CHECK-NEXT:    uaddv d2, p0, z0.b
; CHECK-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEXT:    fmov w8, s2
; CHECK-NEXT:    tbz w8, #0, .LBB7_16
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    fmov h0, wzr
; CHECK-NEXT:    ldr h1, [x0], #2
; CHECK-NEXT:    zip1 z1.h, z1.h, z0.h
...
; CHECK-NEXT:    zip1 z0.d, z1.d, z0.d
; CHECK-NEXT:    mov z1.h, #0 // =0x0
; CHECK-NEXT:    tbnz w8, #1, .LBB7_17
; CHECK-NEXT:  .LBB7_2: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB7_18
; CHECK-NEXT:  .LBB7_3: // %cond.load5
; CHECK-NEXT:    mov w9, #2 // =0x2
...
; CHECK-NEXT:  .LBB7_9: // %cond.load29
; CHECK-NEXT:    ldr h2, [x0], #2
; CHECK-NEXT:    ptrue p0.h, vl1
; CHECK-NEXT:    mov z1.h, p0/m, z2.h
; CHECK-NEXT:    tbnz w8, #9, .LBB7_25
; CHECK-NEXT:  .LBB7_10: // %else34
; CHECK-NEXT:    tbz w8, #10, .LBB7_26
; CHECK-NEXT:  .LBB7_11: // %cond.load37
; CHECK-NEXT:    mov w9, #2 // =0x2
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_13: // %cond.load45
; CHECK-NEXT:    mov w9, #4 // =0x4
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_15: // %cond.load53
; CHECK-NEXT:    mov w9, #6 // =0x6
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_21: // %cond.load17
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_23: // %cond.load25
; CHECK-NEXT:    mov w9, #7 // =0x7
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_25: // %cond.load33
; CHECK-NEXT:    mov w9, #1 // =0x1
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_27: // %cond.load41
; CHECK-NEXT:    mov w9, #3 // =0x3
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:  .LBB7_29: // %cond.load49
; CHECK-NEXT:    mov w9, #5 // =0x5
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov z3.h, w9
...
; CHECK-NEXT:    tbz w8, #15, .LBB7_32
; CHECK-NEXT:  .LBB7_31: // %cond.load57
; CHECK-NEXT:    mov w8, #7 // =0x7
; CHECK-NEXT:    index z2.h, #0, #1
; CHECK-NEXT:    ptrue p0.h
...
; NONEON-NOSVE-NEXT:    ldr q1, [sp, #32]
; NONEON-NOSVE-NEXT:  .LBB7_19: // %else58
; NONEON-NOSVE-NEXT:    add sp, sp, #992
; NONEON-NOSVE-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB7_20: // %cond.load5
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #848]
...
; NONEON-NOSVE-NEXT:  .LBB7_21: // %cond.load9
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #784]
...
; NONEON-NOSVE-NEXT:  .LBB7_23: // %cond.load17
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #656]
...
; NONEON-NOSVE-NEXT:  .LBB7_24: // %cond.load21
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #592]
...
; NONEON-NOSVE-NEXT:  .LBB7_25: // %cond.load25
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q0, [sp, #512]
...
; NONEON-NOSVE-NEXT:  .LBB7_26: // %cond.load29
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #464]
; NONEON-NOSVE-NEXT:    add x9, sp, #464
...
; NONEON-NOSVE-NEXT:  .LBB7_27: // %cond.load33
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #400]
; NONEON-NOSVE-NEXT:    ldr w10, [sp, #412]
...
; NONEON-NOSVE-NEXT:  .LBB7_28: // %cond.load37
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #336]
...
; NONEON-NOSVE-NEXT:  .LBB7_29: // %cond.load41
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #272]
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #280]
...
; NONEON-NOSVE-NEXT:  .LBB7_30: // %cond.load45
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #208]
...
; NONEON-NOSVE-NEXT:  .LBB7_31: // %cond.load49
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #144]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #156]
...
; NONEON-NOSVE-NEXT:  .LBB7_32: // %cond.load53
; NONEON-NOSVE-NEXT:    ldr h2, [x0], #2
; NONEON-NOSVE-NEXT:    str q1, [sp, #80]
; NONEON-NOSVE-NEXT:    ldr w9, [sp, #88]
...
; NONEON-NOSVE-NEXT:    b .LBB7_19
  %load = call <16 x half> @llvm.masked.expandload.v16f16(ptr %src, <16 x i1> %mask, <16 x half> zeroinitializer)
  ret <16 x half> %load
}
...
; CHECK-NEXT:    zip1 z0.s, z1.s, z0.s
; CHECK-NEXT:    tbnz w8, #1, .LBB8_3
; CHECK-NEXT:    b .LBB8_4
; CHECK-NEXT:  .LBB8_2:
; CHECK-NEXT:    mov z0.s, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB8_4
; CHECK-NEXT:  .LBB8_3: // %cond.load1
...
; NONEON-NOSVE-NEXT:  // %bb.1: // %cond.load
; NONEON-NOSVE-NEXT:    ldr s0, [x0], #4
; NONEON-NOSVE-NEXT:    str wzr, [sp, #36]
...
; NONEON-NOSVE-NEXT:    ldr s1, [x0]
; NONEON-NOSVE-NEXT:    str d0, [sp]
; NONEON-NOSVE-NEXT:    str s1, [sp, #24]
...
; NONEON-NOSVE-NEXT:    ret
  %load = call <2 x float> @llvm.masked.expandload.v2f32(ptr %src, <2 x i1> %mask, <2 x float> zeroinitializer)
  ret <2 x float> %load
}
...
; CHECK-NEXT:    zip1 z0.s, z0.s, z0.s
; CHECK-NEXT:    zip1 z0.d, z1.d, z0.d
; CHECK-NEXT:    tbnz w8, #1, .LBB9_3
; CHECK-NEXT:    b .LBB9_4
; CHECK-NEXT:  .LBB9_2:
; CHECK-NEXT:    mov z0.s, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB9_4
...
; NONEON-NOSVE-NEXT:    str d0, [sp, #216]
; NONEON-NOSVE-NEXT:    ldrh w8, [sp, #218]
; NONEON-NOSVE-NEXT:    ldrh w9, [sp, #220]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #222]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #216]
; NONEON-NOSVE-NEXT:    sbfx w8, w8, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w9, w9, #0, #1
; NONEON-NOSVE-NEXT:    sbfx w10, w10, #0, #1
; NONEON-NOSVE-NEXT:    and w8, w8, #0x2
...
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB9_7: // %cond.load5
; NONEON-NOSVE-NEXT:    ldr s1, [x0], #4
; NONEON-NOSVE-NEXT:    str q0, [sp, #80]
...
; NONEON-NOSVE-NEXT:  .LBB9_8: // %cond.load9
; NONEON-NOSVE-NEXT:    ldr s1, [x0]
; NONEON-NOSVE-NEXT:    str q0, [sp]
; NONEON-NOSVE-NEXT:    ldr x8, [sp]
...
; NONEON-NOSVE-NEXT:    add sp, sp, #224
; NONEON-NOSVE-NEXT:    ret
  %load = call <4 x float> @llvm.masked.expandload.v4f32(ptr %src, <4 x i1> %mask, <4 x float> zeroinitializer)
  ret <4 x float> %load
}
...
; CHECK-NEXT:    zip1 z0.d, z1.d, z0.d
; CHECK-NEXT:    mov z1.s, #0 // =0x0
; CHECK-NEXT:    tbnz w8, #1, .LBB10_9
; CHECK-NEXT:  .LBB10_2: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB10_10
; CHECK-NEXT:  .LBB10_3: // %cond.load5
; CHECK-NEXT:    mov w9, #2 // =0x2
...
; CHECK-NEXT:  .LBB10_5: // %cond.load13
; CHECK-NEXT:    ldr s2, [x0], #4
; CHECK-NEXT:    ptrue p0.s, vl1
; CHECK-NEXT:    mov z1.s, p0/m, z2.s
; CHECK-NEXT:    tbnz w8, #5, .LBB10_13
; CHECK-NEXT:  .LBB10_6: // %else18
; CHECK-NEXT:    tbz w8, #6, .LBB10_14
; CHECK-NEXT:  .LBB10_7: // %cond.load21
; CHECK-NEXT:    mov w9, #2 // =0x2
; CHECK-NEXT:    index z2.s, #0, #1
; CHECK-NEXT:    ptrue p0.s
; CHECK-NEXT:    mov z3.s, w9
...
; CHECK-NEXT:  .LBB10_11: // %cond.load9
; CHECK-NEXT:    mov w9, #3 // =0x3
; CHECK-NEXT:    index z2.s, #0, #1
; CHECK-NEXT:    ptrue p0.s
; CHECK-NEXT:    mov z3.s, w9
...
; CHECK-NEXT:  .LBB10_13: // %cond.load17
; CHECK-NEXT:    mov w9, #1 // =0x1
; CHECK-NEXT:    index z2.s, #0, #1
; CHECK-NEXT:    ptrue p0.s
; CHECK-NEXT:    mov z3.s, w9
...
; CHECK-NEXT:    tbz w8, #7, .LBB10_16
; CHECK-NEXT:  .LBB10_15: // %cond.load25
; CHECK-NEXT:    mov w8, #3 // =0x3
; CHECK-NEXT:    index z2.s, #0, #1
; CHECK-NEXT:    ptrue p0.s
...
; NONEON-NOSVE-NEXT:  .LBB10_6: // %else10
; NONEON-NOSVE-NEXT:    tbnz w8, #4, .LBB10_14
; NONEON-NOSVE-NEXT:  .LBB10_7: // %else14
; NONEON-NOSVE-NEXT:    tbnz w8, #5, .LBB10_15
; NONEON-NOSVE-NEXT:  .LBB10_8: // %else18
; NONEON-NOSVE-NEXT:    tbnz w8, #6, .LBB10_16
; NONEON-NOSVE-NEXT:  .LBB10_9: // %else22
; NONEON-NOSVE-NEXT:    tbz w8, #7, .LBB10_11
; NONEON-NOSVE-NEXT:  .LBB10_10: // %cond.load25
; NONEON-NOSVE-NEXT:    ldr s2, [x0]
; NONEON-NOSVE-NEXT:    str q1, [sp]
; NONEON-NOSVE-NEXT:    ldr x8, [sp]
...
; NONEON-NOSVE-NEXT:    ldr q1, [sp, #32]
; NONEON-NOSVE-NEXT:  .LBB10_11: // %else26
; NONEON-NOSVE-NEXT:    ldr x29, [sp, #480] // 8-byte Reload
; NONEON-NOSVE-NEXT:    add sp, sp, #496
; NONEON-NOSVE-NEXT:    ret
...
; NONEON-NOSVE-NEXT:  .LBB10_15: // %cond.load17
; NONEON-NOSVE-NEXT:    ldr s2, [x0], #4
; NONEON-NOSVE-NEXT:    str q1, [sp, #144]
...
; NONEON-NOSVE-NEXT:  .LBB10_16: // %cond.load21
; NONEON-NOSVE-NEXT:    ldr s2, [x0], #4
; NONEON-NOSVE-NEXT:    str q1, [sp, #80]
...
; NONEON-NOSVE-NEXT:    b .LBB10_11
  %load = call <8 x float> @llvm.masked.expandload.v8f32(ptr %src, <8 x i1> %mask, <8 x float> zeroinitializer)
  ret <8 x float> %load
}
...
; CHECK-NEXT:    str b0, [sp, #12]
; CHECK-NEXT:    ldrb w8, [sp, #12]
; CHECK-NEXT:    tbz w8, #0, .LBB11_2
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    fmov d0, xzr
; CHECK-NEXT:    ldr d1, [x0], #8
; CHECK-NEXT:    zip1 z0.d, z1.d, z0.d
; CHECK-NEXT:    tbnz w8, #1, .LBB11_3
; CHECK-NEXT:    b .LBB11_4
; CHECK-NEXT:  .LBB11_2:
; CHECK-NEXT:    mov z0.d, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB11_4
; CHECK-NEXT:  .LBB11_3: // %cond.load1
; CHECK-NEXT:    mov w8, #1 // =0x1
...
; NONEON-NOSVE-NEXT:    str d0, [sp, #88]
; NONEON-NOSVE-NEXT:    ldr w8, [sp, #92]
; NONEON-NOSVE-NEXT:    ldrb w9, [sp, #88]
; NONEON-NOSVE-NEXT:    sbfx w8, w8, #0, #1
; NONEON-NOSVE-NEXT:    and w8, w8, #0x2
; NONEON-NOSVE-NEXT:    bfxil w8, w9, #0, #1
; NONEON-NOSVE-NEXT:    tbz w8, #0, .LBB11_2
; NONEON-NOSVE-NEXT:  // %bb.1: // %cond.load
; NONEON-NOSVE-NEXT:    ldr d0, [x0], #8
...
; NONEON-NOSVE-NEXT:    ret
  %load = call <2 x double> @llvm.masked.expandload.v2f64(ptr %src, <2 x i1> %mask, <2 x double> zeroinitializer)
  ret <2 x double> %load
}
...
; CHECK-NEXT:    mov z0.d, #0 // =0x0
; CHECK-NEXT:    ldrb w8, [sp, #12]
; CHECK-NEXT:    tbz w8, #0, .LBB12_4
; CHECK-NEXT:  // %bb.1: // %cond.load
; CHECK-NEXT:    fmov d0, xzr
; CHECK-NEXT:    ldr d1, [x0], #8
; CHECK-NEXT:    zip1 z0.d, z1.d, z0.d
; CHECK-NEXT:    mov z1.d, #0 // =0x0
; CHECK-NEXT:    tbnz w8, #1, .LBB12_5
; CHECK-NEXT:  .LBB12_2: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB12_6
; CHECK-NEXT:  .LBB12_3: // %cond.load5
; CHECK-NEXT:    ldr d2, [x0], #8
; CHECK-NEXT:    ptrue p0.d, vl1
; CHECK-NEXT:    mov z1.d, p0/m, z2.d
; CHECK-NEXT:    tbz w8, #3, .LBB12_8
; CHECK-NEXT:    b .LBB12_7
; CHECK-NEXT:  .LBB12_4: // %else
; CHECK-NEXT:    tbz w8, #1, .LBB12_2
; CHECK-NEXT:  .LBB12_5: // %cond.load1
; CHECK-NEXT:    mov w9, #1 // =0x1
...
; NONEON-NOSVE-NEXT:    ldrh w8, [sp, #218]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #220]
; NONEON-NOSVE-NEXT:    ldrh w11, [sp, #222]
; NONEON-NOSVE-NEXT:    ldrh w12, [sp, #216]
...
; NONEON-NOSVE-NEXT:  .LBB12_6: // %else10
; NONEON-NOSVE-NEXT:    add sp, sp, #224
; NONEON-NOSVE-NEXT:    ret
; NONEON-NOSVE-NEXT:  .LBB12_7: // %cond.load5
; NONEON-NOSVE-NEXT:    ldr d2, [x0], #8
; NONEON-NOSVE-NEXT:    str q1, [sp, #80]
...
; NONEON-NOSVE-NEXT:  .LBB12_8: // %cond.load9
...
; NONEON-NOSVE-NEXT:    add sp, sp, #224
; NONEON-NOSVE-NEXT:    ret
  %load = call <4 x double> @llvm.masked.expandload.v4f64(ptr %src, <4 x i1> %mask, <4 x double> zeroinitializer)
  ret <4 x double> %load
}
...
; CHECK-NEXT:    bfi w8, w2, #1, #1
; CHECK-NEXT:    bfi w8, w3, #2, #1
; CHECK-NEXT:    tbz w8, #0, .LBB13_2
; CHECK-NEXT:  // %bb.1: // %cond.load
...
; CHECK-NEXT:    zip1 z1.h, z1.h, z0.h
; CHECK-NEXT:    zip1 z0.s, z1.s, z0.s
; CHECK-NEXT:    tbnz w8, #1, .LBB13_3
; CHECK-NEXT:    b .LBB13_4
; CHECK-NEXT:  .LBB13_2:
; CHECK-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB13_4
; CHECK-NEXT:  .LBB13_3: // %cond.load1
; CHECK-NEXT:    ldrh w9, [x0], #2
; CHECK-NEXT:    fmov s1, w9
; CHECK-NEXT:    zip1 z1.h, z0.h, z1.h
; CHECK-NEXT:    mov z0.h, z0.h[2]
; CHECK-NEXT:    zip1 z0.s, z1.s, z0.s
; CHECK-NEXT:  .LBB13_4: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB13_6
; CHECK-NEXT:  // %bb.5: // %cond.load5
; CHECK-NEXT:    mov z1.h, z0.h[1]
; CHECK-NEXT:    zip1 z0.h, z0.h, z1.h
; CHECK-NEXT:    ldr h1, [x0]
; CHECK-NEXT:    zip1 z0.s, z0.s, z1.s
; CHECK-NEXT:  .LBB13_6: // %else6
...
; NONEON-NOSVE-NEXT:    stur wzr, [sp, #74]
...
; NONEON-NOSVE-NEXT:  // %bb.5: // %cond.load5
...
; NONEON-NOSVE-NEXT:    ldr d0, [sp, #48]
; NONEON-NOSVE-NEXT:  .LBB13_6: // %else6
; NONEON-NOSVE-NEXT:    str d0, [sp, #8]
...
; NONEON-NOSVE-NEXT:    ret
  %load_value = tail call <3 x i16> @llvm.masked.expandload.v3i16.p0(ptr %load_ptr, <3 x i1> %pm, <3 x i16> zeroinitializer)
...
; CHECK-NEXT:    zip1 z1.h, z1.h, z0.h
; CHECK-NEXT:    zip1 z0.s, z1.s, z0.s
; CHECK-NEXT:    tbnz w8, #1, .LBB14_3
; CHECK-NEXT:    b .LBB14_4
; CHECK-NEXT:  .LBB14_2:
; CHECK-NEXT:    mov z0.h, #0 // =0x0
; CHECK-NEXT:    tbz w8, #1, .LBB14_4
; CHECK-NEXT:  .LBB14_3: // %cond.load1
; CHECK-NEXT:    ldrh w9, [x0], #2
; CHECK-NEXT:    fmov s1, w9
; CHECK-NEXT:    zip1 z1.h, z0.h, z1.h
; CHECK-NEXT:    mov z0.h, z0.h[2]
; CHECK-NEXT:    zip1 z0.s, z1.s, z0.s
; CHECK-NEXT:  .LBB14_4: // %else2
; CHECK-NEXT:    tbz w8, #2, .LBB14_6
; CHECK-NEXT:  // %bb.5: // %cond.load5
; CHECK-NEXT:    mov z1.h, z0.h[1]
; CHECK-NEXT:    zip1 z0.h, z0.h, z1.h
; CHECK-NEXT:    ldr h1, [x0]
; CHECK-NEXT:    zip1 z0.s, z0.s, z1.s
; CHECK-NEXT:  .LBB14_6: // %else6
...
; NONEON-NOSVE-NEXT:    str w8, [sp, #48]
; NONEON-NOSVE-NEXT:    ldr d0, [sp, #48]
; NONEON-NOSVE-NEXT:  .LBB14_6: // %else6
; NONEON-NOSVE-NEXT:    str d0, [sp, #8]
