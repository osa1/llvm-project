...
; CHECK-NEXT:    call void @llvm.memset.inline.p0.i64(ptr [[A]], i8 [[VALUE]], i64 [[X]], i1 false), !prof [[PROF1:![0-9]+]]
; CHECK-NEXT:    tail call void @llvm.memset.inline.p0.i64(ptr [[A]], i8 [[VALUE]], i64 [[X]], i1 true)
; CHECK-NEXT:    ret void
;
